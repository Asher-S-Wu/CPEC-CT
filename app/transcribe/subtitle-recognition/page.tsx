...
import { AudioUploader } from '@/components/transcribe/subtitle/audio-uploader';
        ...
        <CardContent>
          <div className="flex flex-col gap-4 sm:flex-row">
            <button
              ...
              className={`flex flex-1 cursor-pointer flex-col items-center gap-2 rounded-lg border p-4 transition-colors ${
                recognitionMode === 'text'
                  ...
                  : 'border-[var(--oa-card-border)] bg-[var(--oa-card-bg)] hover:border-[var(--oa-control-hover-border)]'
              } ${isProcessing ? 'cursor-not-allowed opacity-50' : ''}`}
            >
              <FileText
                className={`h-8 w-8 ${
                  recognitionMode === 'text' ? 'text-[var(--oa-ink)]' : 'text-[var(--oa-muted)]'
                }`}
              />
              <div className="text-center">
                ...
                <div className="text-xs text-[var(--oa-muted)]">适合整理录音文字内容</div>
              </div>
            </button>
            ...
            >
              <Subtitles
                className={`h-8 w-8 ${
                  recognitionMode === 'subtitle' ? 'text-[var(--oa-ink)]' : 'text-[var(--oa-muted)]'
                }`}
              />
              <div className="text-center">
                ...
                <div className="text-xs text-[var(--oa-muted)]">自动生成字幕文件（含时间轴），可导出 SRT 格式</div>
              </div>
            </button>
          </div>
        </CardContent>
